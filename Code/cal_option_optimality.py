...
if __name__ == "__main__":
    ...
    json_file_path_gpt4o_v2 = "/data/code/MoPS/assets/PS_test/option_optimality_gpt4o_3-31_v2.json" # acc: 0.8194154488517745
    json_file_path_qwen_v2 = "/data/code/MoPS/assets/PS_test/option_optimality_qwen-max-2025-01-25_3-31_v2.json" # acc: 0.7745302713987474
    json_file_path_ds_v2 = "/data/code/MoPS/assets/PS_test/option_optimality_deepseek-v3_3-31_v2.json" # 0.7526096033402923
    ...
    matching_pairs_gpt4o_qwen = count_matching_option_optimality(json_file_path_gpt4o_v2, json_file_path_qwen_v2, output_path_gpt4o_qwen)
    matching_pairs_gpt4o_ds = count_matching_option_optimality(json_file_path_gpt4o_v2, json_file_path_ds_v2, output_path_gpt4o_ds)
    matching_pairs_qwen_ds = count_matching_option_optimality(json_file_path_qwen_v2, json_file_path_ds_v2, output_path_qwen_ds)

    acc_gpt4o_qwen = compute_accuracy(output_path_gpt4o_qwen) # gpt4o_qwen acc: 0.7045929018789144
    acc_gpt4o_ds = compute_accuracy(output_path_gpt4o_ds) # gpt4o_ds acc: 0.6910229645093946
    acc_qwen_ds = compute_accuracy(output_path_qwen_ds) # qwen_ds acc: 0.6722338204592901
    ...
    matching_items = compare_three_files_ordered(json_file_path_gpt4o_v2, json_file_path_qwen_v2, json_file_path_ds_v2,output_path_gpt4o_qwen_ds) # 646
    # print(f"matching_items: {matching_items}")
    acc_gpt4o_qwen_ds = compute_accuracy(output_path_gpt4o_qwen_ds)
    print(f"gpt4o_qwen_ds acc: {acc_gpt4o_qwen_ds}") # gpt4o_qwen_ds acc: 0.6315240083507306




    # acc_gpt4o_v2 = compute_accuracy(json_file_path_gpt4o_v2)
    # acc_qwen_v2 = compute_accuracy(json_file_path_qwen_v2)
    acc_ds_v2 = compute_accuracy(json_file_path_ds_v2)
    # print(f"gpt4o_v2 acc: {acc_gpt4o_v2}")
    # print(f"qwen_v2 acc: {acc_qwen_v2}")
    # print(f"ds_v2 acc: {acc_ds_v2}")